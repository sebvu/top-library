...
class Book {
  ...
  constructor(title, author, pages, cover, hasRead) {
    this.title = title;
    this.author = author;
    this.pages = pages;
    this.cover = cover;
...
class Library {
  ...
  toggleBook(id) {
    ...
    if (!bookIndex && bookIndex !== 0)
      throw Error(`Book index not found for ${id}`);
  ...
  addBook(title, author, pages, cover, hasRead) {
  ...
  deleteBook(id) {
    ...
    if (index !== null) {
      ...
      this.books = this.books
        .slice(0, index)
        .concat(this.books.slice(index + 1));
      localStorage.setItem(this.BOOKS_REF_NAME, JSON.stringify(this.books));
    } else {
...
class UILibraryHandler {
  ...
  // build addBookDialog
  #buildAddBookDialog = function (dialog) {
    // header
    ...
    this.#setAttrs(dialogExitSvgPath, {
    ...
    this.#setAttrs(dialogForm, { action: "", method: "" });
    ...
    this.#setAttrs(DialogFormTopP1Input, {
      type: "text",
      id: "title",
      name: "book_title",
    ...
    this.#setAttrs(DialogFormTopP2Input, {
      type: "text",
      id: "author",
      name: "book_title",
    ...
    this.#setAttrs(DialogFormTopDivP1Input, {
      type: "number",
      step: "1",
      id: "pages",
      name: "book_pages",
    ...
    this.#setAttrs(DialogFormTopDivP2Input, {
      type: "checkbox",
      id: "has-read",
      name: "book_has-read",
    });
    ...
    this.#setAttrs(DialogFormTopP3Input, {
      type: "file",
      id: "image",
      name: "book_cover",
    ...
    this.#setAttrs(dialogFormCoverImg, {
      src: "",
    ...
    dialogFormCoverImg.addEventListener("error", () => {
      dialogFormCoverImg.setAttribute(
        "src",
  ...
  buildExistingBooks = function () {
    this.#removeExistingBooks();
    ...
    for (let b of this.library.books) {
      ...
      this.#setAttrs(cardBookmarkIcon, {
        viewBox: "0 0 24 24",
      });
      ...
      this.#setAttrs(cardBookmarkIconPath, {
      ...
      this.#setAttrs(cardButtonBookmarkSvg, {
        height: "24px",
      ...
      this.#setAttrs(cardButtonBookmarkPath, {
      ...
      this.#setAttrs(cardButtonDividerLine, {
        x1: "50%",
        y1: "0",
        x2: "50%",
        y2: "100%",
      ...
      cardButtonDelete.classList.add(
      ...
      this.#setAttrs(cardButtonDeleteSvg, { viewBox: "0 -960 960 960" });
      this.#setAttrs(cardButtonDeleteSvg, {
        height: "24px",
        width: "24px",
      });
      ...
      this.#setAttrs(cardButtonDeletePath, {
      ...
      cardStatusSpan.classList.add(
        ...["_text", "_text--header", "_text--bold"],
      );
